 ...
 *  Last modification date 06/01/2013 06:56 PM.
 *
 * Description :
 *  Config file.
 *
 ...
 */
$_config['output']['url']     = "http://localhost/cliprz_forum/";
$_config['output']['charset'] = "UTF-8";

/**
 * Database driver.
 *
 * @var (boolean) $_config['option']['use_database']  - use a database.
