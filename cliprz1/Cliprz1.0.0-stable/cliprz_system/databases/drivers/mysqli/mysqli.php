 ...
 *  Last modification date 30/01/2013 10:18 PM.
 *
 * Description :
...
class cliprz_database_driver_mysqli
{
    ...
    {
        return trim(mysqli_real_escape_string($this->link_identifier,$escapestr));
    }
    ...
    {
        mysqli_error($this->link_identifier);
    }
    ...
    {
        mysqli_errno($this->link_identifier);
    }
