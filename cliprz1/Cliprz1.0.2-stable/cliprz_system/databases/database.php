 ...
 *  Last modification date 30/01/2013 10:25 PM.
 *
 * Description :
...
class cliprz_database
{
    ...
    public function __construct()
    {
        ...
        {
            trigger_error("Driver object not exists.",E_WARNING);
        }
    ...
    protected static function load_driver ()
    {
        ...
        if (file_exists($driver_path))
        {
            ...
            if (defined($driver_define))
            {
                ...
                {
                    trigger_error($driver_object.' class not exists.',E_WARNING);
                }
            }
            else
            {
                trigger_error($driver_define.' not defined.',E_WARNING);
            }
        }
        else
        {
            trigger_error($_config['db']['driver'].' driver not exists.',E_WARNING);
        }
    }
