...
<meta charset="UTF-8" />
<title>Cliprz</title>
<link rel="stylesheet" href="<?php echo cliprz::system(view)->css("styles.css"); ?>" type="text/css" />
</head>
<body>

<div class="logo">
    <img src="<?php echo cliprz::system(view)->image("logo.png"); ?>" alt="Cliprz" />
</div>

<div class="content">
مرحباً بك في إطار العمل <strong>Cliprz</strong>, أول إطار عمل عربي مجاني ومفتوح المصدر مكتوب باللغة PHP,
هذا الاطار سهل وسريع وآمن للاستخدام يمكنك معرفة المزيد عن الإطار عبر زيارة <a target="_blank" href="http://www.cliprz.org/Manual">المستندات</a> قم بزيارة الموقع الرسمي بشكل دوري لمعرفة آخر الاصدارات والتحديثات .
<br />
<br />
