 ...
 *  Last modification date 29/12/2012 11:49 AM.
 *
 * Description :
 *  Router class.
 *
...
class cliprz_router
{
    ...
    {
        self::$_requested['resource'] = c_trim_path(c_get_request_resource());
    ...
    {
        if (empty(self::$_requested['resource'])
        || is_null(self::$_requested['resource'])
        || preg_match("`{index.php}`i",self::$_requested['resource']))
        {
