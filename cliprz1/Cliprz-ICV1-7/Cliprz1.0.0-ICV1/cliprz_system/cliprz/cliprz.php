 ...
 *  Last modification date 25/11/2012 03:59 PM.
 *
 * Description :
...
final class cliprz
{
     ...
     */
    final public static function system_use($directory,$class)
    {
        $include_path = SYS_PATH.c_trim_path($directory).'/'.$class.'.php';

        if (file_exists($include_path))
        {
            require_once $include_path;

            $controller_class = (string) strtolower($class);
     ...
     * @access public.
     */
    final public static function system($system_class)
    {
        $key = strtolower($system_class);
     ...
     * @access public.
     */
    final public static function get_framework($key)
    {
        $output = null;
        ...
        $configuration_path = SYS_PATH.'configuration/';
     ...
     *  As an example : file name (cliprz.php), class name (cliprz).
     */
    final public static function library_use($directory,$class)
    {
        $include_path = SYS_PATH."libraries/".c_trim_path($directory).'/'.$class.'.php';
     ...
     * @access public.
     */
    final public static function library($library_class)
    {
        $key = strtolower($library_class);
